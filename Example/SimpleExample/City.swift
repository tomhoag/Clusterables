...
/**
 ...
 This structure encapsulates the basic information about a city including
...
public struct City: Clusterable, Equatable, Hashable, Sendable, Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let coordinateContainer = try container.nestedContainer(
            keyedBy: CoordinateKeys.self,
            forKey: .coordinate
        )
